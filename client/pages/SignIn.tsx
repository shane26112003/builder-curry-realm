      ...
      <div className="grid lg:grid-cols-2 gap-10 items-center">
        <div className="order-2 lg:order-1">
          ...
          <p className="mt-4 text-slate-600 max-w-prose">
            Reserve seats exclusively for women, pregnant women, elderly passengers, and women with large luggage. Secure, fast, and convenient.
          </p>
          <ul className="mt-6 grid sm:grid-cols-2 gap-3 text-sm text-slate-600">
            <li className="flex items-center gap-2"><span className="h-2.5 w-2.5 rounded-full bg-emerald-500"></span>Priority seating coach (50×2)</li>
            <li className="flex items-center gap-2"><span className="h-2.5 w-2.5 rounded-full bg-purple-500"></span>Real-time availability</li>
            <li className="flex items-center gap-2"><span className="h-2.5 w-2.5 rounded-full bg-fuchsia-500"></span>Digital ticket</li>
            <li className="flex items-center gap-2"><span className="h-2.5 w-2.5 rounded-full bg-amber-500"></span>Secure authentication</li>
          </ul>
        </div>
        <div className="order-1 lg:order-2">
          <form onSubmit={onSubmit} className="bg-white/80 backdrop-blur rounded-2xl border border-purple-100 p-6 shadow-sm">
            <div className="flex justify-between items-center mb-6">
              ...
              >
                {mode === "in" ? "New here? Sign up" : "Have an account? Sign in"}
              </button>
            </div>
